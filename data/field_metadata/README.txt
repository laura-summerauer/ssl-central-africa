Explanations to cssl_metadata_all.csv

- sample_id: unique identifier for each soil samples; project specific
- sample_location: defines samplling location; is the same for all samples for different soil depths but from the same location
...
- sampling_date: date of sampling, format is differing for different sample sets; a few missing data (will be filled)
